...
public class Pedido {
    ...
    public Pedido(int idPedido, long codigoVendedor, String nombreVendedor, long codigoCliente, String nombreCliente, int listaPrecios, int fechaPedido, String comentariosPedido, ArrayList<Articulo> listaArticulos) {

...
import kt.distribuidoraBJ.constantes.constantes;
import kt.distribuidoraBJ.fragments_secundarios.OpcionesExportacionDialogo;
import kt.distribuidoraBJ.fragments_secundarios.SeleccionarClienteDialogo;
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        btnNuevoPedido.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new SeleccionarClienteDialogo(contexto, finalizoSeleccionarClienteDialogo, 0, null);
...
// revert to using internal storage (not sure if there's an equivalent to the above)
            ...
            switch (resultadoExportacion){
                case 2:
                    nombreArch = "ClientesNuevos" + sYear + mesFormater + diaFormater + horaFormater + minutosFormater + segundosFormater + codigoVendedorArchFormater + ".CSV";
                    break;
                default:
                    nombreArch = "Pedido" + sYear + mesFormater + diaFormater + horaFormater + minutosFormater + segundosFormater + codigoVendedorArchFormater + ".CSV";
                    break;
            }
            ...
            switch (resultadoExportacion){
                case 2:
                    query = "SELECT dni, categoria, nombre, correo, telefono, direccion, codpos, localidad, zona " +
                            "FROM clientesNuevos";
                    break;
                default:
            ...
            switch (resultadoExportacion){
                case 2:
                    linea = "dni, categoria, nombre, correo, telefono, direccion, codpos, localidad, zona" + "\n";
                    break;
                default:
            ...
            while (cursor.moveToNext()) {
                switch (resultadoExportacion){
                    case 2:
                        ...
                        int codpos = cursor.getInt(6);
                        String localidad = cursor.getString(7);
                        int zona = cursor.getInt(8);
                    ...
                    default:
                        ...
                        long codigoVendedor = cursor.getLong(1);
                        String nombreVendedor = cursor.getString(2);
                        long codigoCliente = cursor.getLong(3);
                        ...
                        cursorArt = dbArt.rawQuery(queryArt, null);
                        primerInsert = true;
            ...
            switch (resultadoExportacion){
                case 2:
                    Toast.makeText(contexto, "Archivo de Clientes Nuevos generado en la carpeta de 'Descargas'", Toast.LENGTH_LONG).show();
                    break;
                default:

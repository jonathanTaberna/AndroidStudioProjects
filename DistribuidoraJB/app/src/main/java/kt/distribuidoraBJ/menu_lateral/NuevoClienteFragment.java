...
public class NuevoClienteFragment  extends Fragment {
    ...
    private Spinner spNuevoClienteZonas;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        btnNuevoClienteAceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String zonaS = spNuevoClienteZonas.getSelectedItem().toString();
                if (categoriaS.equals("No hay Zonas cargadas")) {
    ...
    private void llenarSpinerZonas(View view) {
        ...
        arrayAdapter = new ArrayAdapter<String>(contexto,android.R.layout.simple_spinner_item, arraySpinner);
        arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spNuevoClienteZonas.setAdapter(arrayAdapter);
    }
    ...
    public static NuevoClienteFragment newInstance(boolean editarInfo, ClienteNuevo clienteNuevo) {
        ...
        if (editarInfo) {
            ...
            args.putInt("zona", clienteNuevo.getZona());
    ...
    private void setearDatos(long dni, int categoria, String nombre, String correo, String telefono, String direccion, String localidad, int codpos, int zona){
        ...
        descripcion = leerZona(zona);
        elemento = zona + " - " + descripcion;
        spNuevoClienteZonas.setSelection(arrayAdapter.getPosition(elemento));
        /*
    ...
    private void limpiarDatos(){
        ...
        //edtNuevoClienteFechaNacimiento.setText(generarFecha(sDay,sMonth,sYear));
        edtNuevoClienteDni.requestFocus();
        spNuevoClienteZonas.setSelection(0); //seleccionamos el 1er item del spinner
    }

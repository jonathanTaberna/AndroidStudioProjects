...
public class OpcionesExportacionDialogo {
    ...
    private RadioButton rbExportacionDialogoClientesNuevos;
    ...
    public OpcionesExportacionDialogo(Context contexto, FinalizoOpcionesExportacionDialogo actividad, int accion) {
        ...
        rbExportacionDialogoClientesNuevos = (RadioButton) dialogo.findViewById(R.id.rbExportacionDialogoClientesNuevos);
        ...
        rbExportacionDialogoClientesNuevos.setChecked(false);
        ...
        btnDialogAceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rbExportacionDialogoGuardar.isChecked()) {
                    resultado = 1;
                } else if (rbExportacionDialogoClientesNuevos.isChecked()) {
                    resultado = 2;

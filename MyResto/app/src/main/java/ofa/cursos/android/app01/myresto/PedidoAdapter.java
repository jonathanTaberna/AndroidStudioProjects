...
public class PedidoAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup
            parent) {
        //View fila = LayoutInflater.from(this.context)
                //.inflate(R.layout.fila_pedido, parent, false);
        View fila = convertView;
        if (convertView == null) {
            fila = LayoutInflater.from(this.context)
            .inflate(R.layout.fila_pedido, parent, false);
        }
        ...
        btnVer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentDetalle.putExtra("id", idPedido);
...
// Create an explicit intent for an Activity in your app
        ...
        NotificationCompat.Builder mBuilder = new
                NotificationCompat.Builder(this.context, "1")

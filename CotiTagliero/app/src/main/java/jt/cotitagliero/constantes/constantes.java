package jt.cotitagliero.constantes;

public class constantes {

    //preferencias
    public static String cotiTaglieroConfig = "cotiTagliero.config";
    ...
    public static String cotiPaciente = "http://cotitaglieronutricion.com.ar/ws3/paciente/index.php";

    public static String pdfName = "Coti Tagliero Nutricion.pdf";
